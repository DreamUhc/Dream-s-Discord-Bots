...
class DiscordCaptcha {
    ...
    constructor(client) {
        ...
        client.on("guildMemberAdd", async (member) => {
            ...
            member.send({
                embed: {
                    title: 'Captcha Verification (Powered by DiscordCaptcha)', // Please don't modify this line to support us
                    url: 'https://www.npmjs.com/package/discordcaptcha', // Same with this one
                ...
                let filter = m => m.content === code.toString();
                 channel.awaitMessages(filter, {
                    ...
                    member.send('Verification failed. You have to leave the server to pass the test again.');
                });
            });
        });
    }
